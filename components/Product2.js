...
function Product2() {
	return (
		<div className="flex flex-col md:flex-row  w-full p-24 space-y-4 md:space-x-4 justify-between items-center bg-gradient-to-r from-[#6462F0] to-[#9190E9] rounded-[30px] text-white">
